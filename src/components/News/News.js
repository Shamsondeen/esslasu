                                ...
                                <div className="col-lg-4 col-md-6 col-12 mt-2 mb-2">
                                    <div className="post">
                                        <div className="bg-white rounded shadow p-2">
                                            ...
                                            We are proud, delighted and thankful that despite the fears, popularity and terrors of the corona virus pandemic,we still are responsible enough to keep obeying</p>
                                            <div className="read-more mb-3 mt-2"><Link to="/news" className="text-dark"> Read More <i className="fas fa-arrow-right ml-2" /></Link></div>
                                        </div></div></div>
                                {/*End Of 1st Post*/}
                                {/*Start Of 1st Post*/}
                                <div className="col-lg-4 col-md-6 col-12 mt-2 mb-2">
